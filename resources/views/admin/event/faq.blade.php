...
@section('content')
  <div class="d-flex align-items-center justify-content-between mb-4">
    <div class="page-heading mb-0">
      <h1>FAQs of <span class="text-primary">{{ $event->title }}</span></h1>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content modal-content-custom">
        ...
        <div class="modal-body modal-body-custom">
          <form action="{{ route('admin_event_faq_store', $event->id) }}" method="POST">
            @csrf
        ...
        <div class="modal fade" id="modal_edit_{{ $loop->iteration }}" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content modal-content-custom">
              ...
              <div class="modal-body modal-body-custom">
                <form action="{{ route('admin_event_faq_update', $faq->id) }}" method="POST">
                  @csrf
                  @method('PUT')
        ...
        <div class="modal fade" id="modal_delete_{{ $loop->iteration }}" tabindex="-1" aria-labelledby="modalDeleteLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-content-custom">
              ...
              <div class="modal-body modal-body-custom">
                <form action="{{ route('admin_event_faq_delete', $faq->id) }}" method="POST">
                  @csrf
                  @method('DELETE')
                  <div class="mb-3">
                    <p>
